...
if ($ADMIN->fulltree) {
    ...
    */
    ...
    // Forum page.
    $page = new admin_settingpage('theme_moove_forum', get_string('forumsettings', 'theme_moove'));

    $page->add(new admin_setting_heading('theme_moove_forumheading', null,
    ...
    // Disable bottom footer.
    $name = 'theme_moove/imersivecoursemode';
    $title = get_string('imersivecoursemode', 'theme_moove');
    $description = get_string('imersivecoursemode_desc', 'theme_moove');
    $setting = new admin_setting_configcheckbox($name, $title, $description, 0);
    $page->add($setting);

    // Alternative login url.
    $name = 'theme_moove/alternativelogin';
    $title = get_string('alternativelogin', 'theme_moove');
    $description = get_string('alternativelogin_desc', 'theme_moove');
    $default = '';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $page->add($setting);

    // Alternative login url button text.
    $name = 'theme_moove/alternativelogintext';
    $title = get_string('alternativelogintext', 'theme_moove');
    $description = get_string('alternativelogintext_desc', 'theme_moove');
    $default = '';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $page->add($setting);
