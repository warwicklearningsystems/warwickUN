...
if ($darkmodeon) {
    $extraclasses[] = 'moove-darkmode';
}

if (isset($PAGE->cm->modname) && $themesettings->imersivecoursemode) {
...
if (isset($PAGE->cm->modname) && $themesettings->imersivecoursemode) {
    ...
    $courseutil = new \theme_moove\util\course($this->page->course);
    ...
    echo $OUTPUT->render_from_template('theme_moove/incourse_immersive', $templatecontext);
} else {
    if (isset($PAGE->cm->modname) && in_array($PAGE->cm->modname, $moduleswithnavinblocks)) {
