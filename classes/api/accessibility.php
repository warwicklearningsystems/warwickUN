...
class accessibility extends external_api {
    ...
    public static function savethemesettings($formdata) {
        ...
        if ($data['fonttype'] && in_array($data['fonttype'], ['default', 'odafont', 'verdanafont', 'comicsansfont'])) {
            $fonttype = null;
            ...
            if ($data['fonttype'] == 'verdanafont') {
                $fonttype = 'verdanafont';
            }

            if ($data['fonttype'] == 'comicsansfont') {
                $fonttype = 'comicsansfont';
            }
