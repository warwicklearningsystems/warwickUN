...
$string['platform_access'] = 'University of Warwick online teaching and learning platform';
...
$string['themesettingsdyslexicfont'] = 'Dyslexia Friendly Font';
...
$string['darkmode_title'] = 'Colors are affecting your eyes?';
$string['darkmode_enable'] = 'Enable dark mode';
$string['darkmode_disable'] = 'Disable dark mode';
$string['imersivecoursemode'] = 'Enable immersive course mode';
$string['imersivecoursemode_desc'] = 'With this mode enabled, students see activities in an immersive mode.';
